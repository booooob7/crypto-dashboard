...
5. **幣種相關性** — 計算前十大幣（排除穩定幣）每日報酬的皮爾森相關係數，以熱力圖呈現：+1 同向、0 無關、−1 反向，用於觀察分散風險效果。
6. **市場泡泡圖** — 以泡泡大小呈現市值、顏色呈現所選時間範圍漲跌，可切換 1H / 1D / 1W / 1M / 3M，滑鼠懸停可查看價格、市值、成交量與 7 天漲跌。
