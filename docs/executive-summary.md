...
2. **價格走勢圖** — TradingView 風格的價格折線，可在成交量與 RSI 技術指標之間切換；成交量依當日漲跌以紅綠區分，RSI 以 70 / 30 作為強弱區間提示。價格軸置於右側，可切換幣種與 7 天 / 30 天 / 90 天時間範圍。圖表會依範圍自動調整解析度：**7 天內顯示小時級日內資料、30/90 天收斂為日線**，讓高頻更新在短期圖上真正可見、長期圖又保持易讀。
...
6. **市場泡泡圖** — 以泡泡大小呈現所選時間範圍的波動幅度、顏色呈現漲跌方向，可切換 1H / 1D / 1W / 1M / 3M，滑鼠懸停可查看價格、市值、成交量與 7 天漲跌。
